  ...
  return (
    <main className="text-gray-800">
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://jasaprosesbijiplastik.biz.id/contact"
        />
      </Helmet>
      ...
      <section className="min-h-screen max-w-5xl mx-auto px-4 md:px-0 my-8 md:my-12 space-y-12">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto">
            Untuk pertanyaan dan pemesanan, silakan hubungi kami langsung
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <a
              href="tel:+6281290029538"
              className="block text-green-700 hover:underline text-lg font-medium"
            >
              Telepon: +62 812-9002-9538
            </a>
            <a
              href="https://wa.me/6281290029538"
              target="_blank"
              rel="noopener noreferrer"
              className="block text-green-600 hover:underline text-lg font-medium"
            >
              Chat via WhatsApp
            </a>
            <p className="text-gray-700">
              Alamat: Jl. Raya Kosambi Timur. No.36, Kosambi Timur., Kec.
              Kosambi, Kabupaten Tangerang, Banten 15213
            </p>
          </div>
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 mt-6">
            ...
            >
              ...
              {copied === "phone" ? "Telepon Tersalin!" : "Salin Telepon"}
            </button>
          </div>
        </motion.section>
