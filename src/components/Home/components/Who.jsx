...
>>>>>>> 7f91838 (new layout)
            ...
            <p className="text-center text-gray-700 mt-2 mb-6 max-w-2xl mx-auto font-sans">
                Kami memiliki kecepatan produksi yang tinggi, mencapai 10 - 12 ton/hari dan dapat memenuhi permintaan dalam jumlah besar. Dengan pengalaman bertahun-tahun di industri ini, kami berkomitmen untuk memberikan produk berkualitas terbaik dengan harga yang kompetitif.
            </p>
        </div>
    )
}
