          ...
          <div className="w-full order-2 md:order-1 max-w-screen-xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="md:w-1/2 space-y-6">
              <h1 className="text-4xl font-extrabold text-green-900 leading-snug">
                Tingkatkan Kualitas Produksi <br className="hidden md:block" />{" "}
                Plastik Anda
              </h1>
              <p className="text-gray-700 text-lg">
                MP. PLAST hadir dengan teknologi modern untuk memproses biji
                plastik PP — bersih, stabil, dan siap pakai untuk segala
                kebutuhan industri.
              </p>
              <p className="text-gray-600 text-sm">
                Dengan kapasitas produksi hingga 12 ton per hari, kami siap
                memenuhi permintaan Anda dengan kualitas terbaik.
              </p>
              <a
              ...
              <p className="text-xs text-gray-500">
                Buka 24 Jam | Teknologi Mesin Terbaru | Hasil Maksimal, Bersih &
                Stabil
              </p>
            </div>
