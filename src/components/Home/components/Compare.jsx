...
function Compare() {
  return (
    <div className="mt-10 min-h-[50vh] bg-[#fdfbd4] items-center m-auto justify-items-center">
      <h2 className="font-playfair font-bold text-3xl text-center">Produk Unggulan Kami</h2>
      <p className="text-center text-gray-700 mt-2 mb-6 max-w-2xl mx-auto text-base">
        Pilihan biji plastik berkualitas tinggi untuk berbagai kebutuhan industri Anda. Setiap produk kami melalui proses seleksi dan kontrol mutu yang ketat.
      </p>
